...
<div class="container mt-2">
	<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item">
          <img class="d-block w-100 img-fluid" src="images/board.png">
        </div>
        <div class="carousel-item text-center p-4 text-primary">
          <h2>Upcoming Events</h2>
          <p>
            <ul class="events">
              <li>Nine Weeks Testing, Oct 4 - 11</li>
              <li>College and Career Fair, Oct 11</li>
              <li>Football @ JFK, Oct 6 at 7:00pm</li>
              <li>Board Meeting, Oct 9 at 5:30p</li>
