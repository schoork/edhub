...
$courses = array(
	array('name' => '3rd Grade ELA', 'target' => 16.3, 'subject' => 'ela'),
	...
	<div class="row">
		<div class="col-12">
			...
			<p>
				...
				<a class="btn btn-secondary" href="weeklydata_students.php?week=<?php echo $week; ?>">Data By Student</a>
			...
			<table class="table table-sm table-striped dataTbl text-center">
				...
				<tbody>
					...
					foreach ($courses as $course) {
						...
						$query = "SELECT growth, post, core_math, core_ela, core_sci FROM data_scores LEFT JOIN data_enrollment USING (eadms_id) WHERE course = '$name' AND week = '$week'";
...
$(document).ready(function() {
	...
	$("#week").on("change", function() {
		var week = $(this).val();
		window.location.href = 'weeklydata_core.php?week=' + week;
	});
});
</script>
